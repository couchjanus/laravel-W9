                ...
                <tbody>
                  @foreach($tags as $tag)
                    <tr>
                      ...
                      <td>
                        <a title="Read tag" href="{{ route('tags.show', ['id'=> $tag->id]) }}" class="btn btn-primary"><span data-feather="eye"></span></a>
                        <a title="Edit tag" href="{{ route('tags.edit', ['id'=> $tag->id]) }}" class="btn btn-warning"><span data-feather="edit"></span></a>
                        <button title="Delete tag" type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete_tag_{{ $tag->id  }}"><span data-feather="delete"></span></button>
                      </td>
                    </tr>
